    ...
    <div className="text-center lg:text-left space-y-6 lg:space-y-8">
      <div className="space-y-4 lg:space-y-6">
        <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-arial font-bold leading-tight">
          {industryConfig.heroHeadline}{' '}
          <span className="text-accent animate-text-glow animate-best-bounce relative inline-block bg-gradient-to-r from-accent via-accent to-accent bg-[length:200%_100%] animate-shine bg-clip-text">
            {industryConfig.heroHighlight}
          </span>
        </h1>
        <p className="text-lg sm:text-xl lg:text-2xl text-white/90 leading-relaxed max-w-2xl mx-auto lg:mx-0">
          {industryConfig.heroSubtitle}
        </p>
      </div>
