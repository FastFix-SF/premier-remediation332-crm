...
interface StandardProvisionsProps {
  legalName?: string;
}

export const StandardProvisionsPages: React.FC<StandardProvisionsProps> = ({ legalName = 'THE COMPANY, INC' }) => {
  return (
    <>
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.provisionsText}>
          ...
          lawns, shrubs, etc. The Owner will point out and warrant the property lines to {legalName}. Spark arrestors, gutters, chimneys,
      ...
      <Page size="LETTER" style={styles.page}>
        ...
        <Text style={styles.provisionsText}>
          {legalName} hereby warrants, subject to the Terms and Conditions set forth herein, that it will make all necessary repairs to leaks
          which result from defects in workmanship and materials furnished by {legalName} at no cost to the Owner when those leaks occur within
        ...
        <Text style={styles.provisionsText}>
          Work shall be deemed to have commenced when {legalName} begins work at the job site or orders materials, equipment, or supplies relating
